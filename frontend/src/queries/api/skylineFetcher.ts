import { SkylineContext } from './skylineContext';

const baseUrl = ''; // TODO add your baseUrl

export type ErrorWrapper<TError> = TError | { status: 'unknown'; payload: string };

export type SkylineFetcherOptions<TBody, THeaders, TQueryParams, TPathParams> = {
    url: string;
    method: string;
    body?: TBody;
    headers?: THeaders;
...
>({
    ...
    queryParams,
    signal,
}: SkylineFetcherOptions<TBody, THeaders, TQueryParams, TPathParams>): Promise<TData> {
    try {
